...
var (
	...
	ngReelStrips96_8 = games.ReelStrips{
		{7, 2, 4, 13, 13, 6, 8, 2, 4, 9, 7, 1, 1, 11, 1, 1, 4, 2, 3, 7, 4, 10, 1, 2, 3, 9, 8, 2, 1, 3, 5, 4, 6, 4, 13, 13, 13, 4, 2, 6, 4, 2, 1, 3, 4, 2, 5, 8, 1, 1, 1, 2, 1, 4, 1, 1, 3, 2, 5, 1, 11, 10, 5},
		{7, 5, 3, 7, 6, 0, 3, 6, 4, 7, 8, 1, 3, 6, 13, 13, 13, 7, 5, 2, 3, 1, 6, 3, 6, 13, 13, 13, 6, 6, 0, 8, 2, 3, 7, 5, 4, 1, 3, 6, 11, 9, 1, 3, 7, 2, 5, 3, 1, 10, 4, 1, 3, 6, 1, 0, 7, 2, 9, 5, 11, 10, 2},
	...
	hifgReelStrips96_8 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips96_8 = games.ReelStrips{
...
var (
	...
	ngReelStrips96_18 = games.ReelStrips{
		...
		{4, 5, 3, 7, 6, 0, 3, 1, 7, 3, 8, 1, 4, 6, 13, 13, 13, 7, 5, 4, 4, 3, 6, 1, 6, 13, 13, 13, 6, 3, 0, 8, 2, 2, 1, 5, 11, 1, 4, 6, 4, 9, 1, 4, 7, 1, 5, 4, 1, 10, 3, 2, 3, 6, 1, 0, 7, 2, 9, 5, 11, 10, 2},
		{1, 4, 4, 6, 3, 8, 1, 2, 6, 1, 2, 5, 7, 3, 8, 1, 5, 3, 10, 5, 3, 11, 13, 13, 13, 1, 4, 4, 5, 5, 0, 5, 2, 13, 13, 13, 11, 5, 2, 0, 1, 11, 4, 4, 7, 1, 4, 8, 1, 9, 5, 2, 9, 0, 10, 5, 2, 10, 9, 2, 5, 4, 4},
	...
	hifgReelStrips96_18 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips96_18 = games.ReelStrips{
		{8, 2, 6, 1, 11, 2, 3, 1, 7, 2, 1, 4, 10, 2, 1, 6, 2, 3, 4, 1, 2, 3, 11, 1, 2, 3, 10, 1, 3, 4, 2, 9, 3, 5, 9, 1, 3, 1, 2, 10, 2, 3, 11, 5, 2, 1, 8, 5, 1, 3, 7, 3, 2, 1},
		{3, 4, 3, 4, 8, 5, 6, 3, 5, 9, 4, 5, 2, 5, 6, 4, 10, 5, 8, 7, 4, 8, 5, 10, 4, 9, 6, 5, 4, 6, 5, 0, 6, 7, 4, 11, 1, 6, 11, 2, 4, 6, 4, 3, 5, 4, 1, 2},
		{3, 4, 3, 4, 8, 5, 6, 3, 5, 9, 4, 5, 2, 5, 6, 4, 10, 5, 8, 7, 4, 8, 5, 10, 4, 9, 6, 5, 4, 6, 5, 0, 6, 7, 4, 11, 1, 6, 11, 2, 4, 6, 4, 3, 5, 4, 1, 2},
		{3, 4, 3, 4, 8, 5, 6, 3, 5, 9, 4, 5, 2, 5, 6, 4, 10, 5, 8, 7, 4, 8, 5, 10, 4, 9, 6, 5, 4, 6, 5, 0, 6, 7, 4, 11, 1, 6, 11, 2, 4, 6, 4, 3, 5, 4, 1, 2},
...
var (
	...
	ngReelStrips96_38 = games.ReelStrips{
		{2, 1, 6, 1, 2, 3, 4, 2, 9, 2, 4, 11, 1, 3, 2, 2, 9, 1, 3, 11, 2, 2, 4, 7, 1, 2, 4, 5, 11, 3, 3, 3, 5, 11, 2, 2, 9, 2, 4, 10, 2, 1, 10, 2, 1, 6, 13, 13, 13, 8, 3, 3, 3, 7, 5, 2, 6, 13, 13, 13, 8, 5, 2, 4, 8, 2, 9, 2, 4, 10, 2, 7, 1, 2, 1, 6, 13, 13, 1, 7, 2, 2, 8, 4, 2, 5, 10},
	...
	hifgReelStrips96_38 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips96_38 = games.ReelStrips{
		{8, 2, 6, 1, 11, 2, 3, 1, 7, 2, 1, 4, 10, 2, 1, 6, 2, 3, 4, 1, 2, 3, 11, 1, 2, 3, 10, 1, 3, 4, 2, 9, 3, 5, 9, 1, 3, 1, 2, 10, 2, 3, 11, 5, 2, 1, 8, 5, 1, 3, 7, 3, 2, 1},
...
var (
	...
	ngReelStrips96_68 = games.ReelStrips{
		...
		{0, 6, 2, 2, 6, 3, 3, 6, 7, 5, 4, 7, 5, 3, 4, 7, 5, 4, 10, 8, 1, 1, 1, 1, 1, 2, 1, 1, 8, 1, 1, 1, 1, 9, 3, 5, 9, 13, 13, 13, 8, 3, 2, 9, 13, 13, 8, 4, 3, 11, 10, 0, 2, 10, 4, 4, 4, 11, 3, 4, 10, 0, 3, 6, 2, 1, 4, 11, 0, 4, 6, 2, 2, 6, 1, 2, 2, 1, 2, 7, 13, 13, 13, 7, 3, 1, 1, 3, 0, 7, 5, 1, 9, 0, 1, 11, 2},
	...
	hifgReelStrips96_68 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips96_68 = games.ReelStrips{
...
var (
	// RTP: 97.963%
	ngReelStrips96_88 = games.ReelStrips{
		{1, 1, 5, 1, 1, 5, 1, 6, 1, 2, 6, 3, 2, 7, 3, 2, 7, 4, 4, 8, 3, 3, 9, 4, 4, 10, 3, 1, 11, 2, 2, 10, 1, 1, 1, 1, 1, 4, 4, 6, 5, 4, 6, 1, 4, 7, 13, 13, 13, 7, 1, 1, 8, 2, 2, 2, 8, 13, 13, 13, 9, 4, 4, 11, 2, 2, 2, 9, 2, 4, 10, 5, 4, 8, 3, 2, 10, 3, 4, 11, 1, 3, 6, 13, 13, 7, 2, 2, 2, 6, 3, 3, 7, 4, 5, 9, 5, 1, 11, 5, 4},
	...
	hifgReelStrips96_88 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips96_88 = games.ReelStrips{
