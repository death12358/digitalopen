...
var (
	...
	ngReelStrips88_8 = games.ReelStrips{
		...
		{7, 5, 3, 7, 6, 1, 3, 1, 4, 7, 8, 1, 3, 6, 13, 13, 13, 7, 5, 2, 3, 1, 6, 3, 6, 13, 13, 13, 6, 1, 0, 8, 2, 3, 7, 5, 4, 1, 3, 6, 11, 9, 1, 3, 7, 2, 5, 3, 1, 10, 4, 1, 3, 6, 1, 0, 7, 2, 9, 5, 11, 10, 2},
	...
	hifgReelStrips88_8 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips88_8 = games.ReelStrips{
...
var (
	ngReelStrips88_18 = games.ReelStrips{
		...
		{4, 4, 4, 6, 3, 8, 1, 2, 6, 1, 2, 5, 7, 3, 8, 1, 5, 3, 10, 5, 3, 11, 13, 13, 13, 5, 4, 8, 4, 5, 11, 2, 5, 13, 13, 13, 11, 5, 2, 0, 1, 11, 4, 5, 7, 1, 4, 8, 1, 9, 2, 4, 9, 0, 10, 5, 2, 1, 9, 2, 4, 4, 5},
	...
	hifgReelStrips88_18 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips88_18 = games.ReelStrips{
		{8, 2, 6, 1, 11, 2, 3, 1, 7, 2, 1, 4, 10, 2, 1, 6, 2, 3, 4, 1, 2, 3, 11, 1, 2, 3, 10, 1, 3, 4, 2, 9, 3, 5, 9, 1, 3, 1, 2, 10, 2, 3, 11, 5, 2, 1, 8, 5, 1, 3, 7, 3, 2, 1},
		{3, 4, 3, 4, 8, 5, 6, 3, 5, 9, 4, 5, 2, 5, 6, 4, 10, 5, 8, 7, 4, 8, 5, 10, 4, 9, 6, 5, 4, 6, 5, 0, 6, 7, 4, 11, 1, 6, 11, 2, 4, 6, 4, 3, 5, 4, 1, 2},
		{3, 4, 3, 4, 8, 5, 6, 3, 5, 9, 4, 5, 2, 5, 6, 4, 10, 5, 8, 7, 4, 8, 5, 10, 4, 9, 6, 5, 4, 6, 5, 0, 6, 7, 4, 11, 1, 6, 11, 2, 4, 6, 4, 3, 5, 4, 1, 2},
		{3, 4, 3, 4, 8, 5, 6, 3, 5, 9, 4, 5, 2, 5, 6, 4, 10, 5, 8, 7, 4, 8, 5, 10, 4, 9, 6, 5, 4, 6, 5, 0, 6, 7, 4, 11, 1, 6, 11, 2, 4, 6, 4, 3, 5, 4, 1, 2},
...
var (
	ngReelStrips88_38 = games.ReelStrips{
		{2, 1, 6, 1, 2, 3, 4, 2, 9, 3, 4, 11, 1, 3, 1, 2, 9, 1, 3, 11, 2, 2, 4, 7, 1, 2, 4, 5, 11, 2, 2, 3, 5, 11, 3, 2, 9, 3, 4, 10, 2, 1, 10, 2, 1, 6, 13, 13, 13, 8, 3, 3, 3, 7, 5, 2, 6, 13, 13, 13, 8, 5, 2, 4, 8, 2, 9, 2, 4, 10, 2, 7, 1, 2, 1, 6, 13, 13, 1, 7, 2, 4, 8, 4, 4, 5, 10},
		...
		{0, 8, 1, 2, 11, 3, 2, 10, 1, 1, 1, 8, 2, 2, 2, 9, 1, 3, 4, 11, 0, 10, 1, 2, 7, 3, 5, 6, 13, 13, 10, 2, 1, 5, 7, 4, 4, 10, 1, 2, 9, 0, 11, 1, 4, 4, 7, 5, 2, 8, 0, 11, 2, 2, 2, 2, 6, 13, 13, 13, 9, 4, 5, 2, 6, 13, 13, 9, 3, 2, 3, 4, 7, 3, 4, 5, 4, 6, 1, 3, 4, 8, 4},
		{3, 1, 1, 11, 1, 3, 5, 2, 1, 4, 6, 1, 3, 5, 1, 10, 1, 5, 3, 1, 2, 7, 1, 3, 4, 6, 13, 13, 5, 2, 3, 7, 3, 2, 10, 2, 2, 7, 2, 2, 8, 2, 4, 3, 2, 4, 9, 1, 1, 1, 9, 13, 13, 13, 10, 2, 4, 3, 2, 3, 8, 2, 2, 3, 2, 6, 13, 13, 5, 11, 1, 4, 8, 1, 4, 9, 4, 3, 4, 3, 1, 4, 2, 3},
	}

	hifgReelStrips88_38 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips88_38 = games.ReelStrips{
		{8, 2, 6, 1, 11, 2, 3, 1, 7, 2, 1, 4, 10, 2, 1, 6, 2, 3, 4, 1, 2, 3, 11, 1, 2, 3, 10, 1, 3, 4, 2, 9, 3, 5, 9, 1, 3, 1, 2, 10, 2, 3, 11, 5, 2, 1, 8, 5, 1, 3, 7, 3, 2, 1},
...
var (
	...
	ngReelStrips88_68 = games.ReelStrips{
		...
		{0, 8, 3, 1, 4, 3, 1, 1, 1, 1, 1, 1, 3, 10, 3, 7, 1, 6, 5, 7, 0, 11, 4, 2, 4, 4, 8, 2, 5, 10, 3, 3, 10, 5, 2, 11, 4, 4, 1, 2, 7, 0, 4, 3, 11, 1, 3, 3, 10, 1, 0, 11, 6, 1, 2, 4, 9, 13, 13, 13, 9, 1, 8, 5, 9, 13, 13, 9, 5, 9, 5, 6, 7, 0, 1, 1, 2, 2, 2, 2, 2, 2, 2, 2, 6, 5, 6, 8, 13, 13, 8, 2, 2, 3, 7},
	...
	hifgReelStrips88_68 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips88_68 = games.ReelStrips{
...
var (
	// RTP: 97.883%
	ngReelStrips88_88 = games.ReelStrips{
	...
	hifgReelStrips88_88 = games.ReelStrips{
	...
	// 中間 2 3 4 大圖，同一座標去算
	bigfgReelStrips88_88 = games.ReelStrips{
